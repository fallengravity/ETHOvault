DApp = {
    ...
    development: true,
    //Rinkeby:
    factoryAddress: "0x44CbbFDc6460e2D5fBe37A1B3A527a72E6A2353b",
    ...
    hashFormatter: function(hash, row, index){
        ...
        return `<a href="https://explorer.ether1.org/addr/${hash}">${shortHash}...</a>`;
    },
    ...
    valueFormatter: function(cell, row){
        ...
        console.log("xxxx", row['Vault Address'], ethValue, toptalValue);
